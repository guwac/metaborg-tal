...
public class TALParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("TAL");
  ...
  { 
    TALParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TALParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TALParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TALParseControllerGenerated.class);
    }
  ...
  { 
    return TALParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
